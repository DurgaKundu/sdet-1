...
public class Activity13_2a {
   ...
   public void writeExcel(String filePath) throws IOException {
	   ...
	   List<String[]> data = new ArrayList<String[]>();
	        ...
	        String[] row1 = {"1", "Durga", "Kundu", "dk@example.com", "4537829158"};
	        String[] row2 = {"2", "Samir", "Pradhan", "sprad@example.com", "4892184058"};
	        String[] row3 = {"3", "Mitthi", "Roy", "roym.m@example.com", "4528727830"};
